...
import { submitVictimReport, clearVictimState } from "../Redux/Slices/victimSlice";
...
export default function VictimReport() {
  ...
  const { loading, success, error } = useSelector((state) => state.victim);
  const locationState = useLocation();
  const serviceType = locationState.state?.serviceType || "general";
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("type", serviceType); // Pass the service type
    ...
    dispatch(submitVictimReport(formData));
  };
